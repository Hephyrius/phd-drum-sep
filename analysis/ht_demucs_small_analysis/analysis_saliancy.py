...
model = DrumHybridDemucs.load_from_checkpoint(f'/homes/hsk01/drum_sep/transdemucs/checkpoint/epoch_280.ckpt')
model.to('cuda')
model = model.eval()
...
df.to_csv('/homes/hsk01/drum_sep/transdemucs/saliance.csv')
print(df)